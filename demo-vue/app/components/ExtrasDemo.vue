<template>
  <Page class="page">
    <ActionBar class="action-bar" title="Carousel Extras Demo"/>

     <GridLayout class="carousel-layout-fix">
        <Carousel id="carousel" @pageChanged="myChangeEvent" ios:indicatorOffset="0,-10" ios:finite="true" ios:bounce="false" showIndicator="true" indicatorAnimation="SWAP"
