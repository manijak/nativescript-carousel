...
declare class DKCarouselView extends UIView {
  ...
  ): DKCarouselView; // inherited from UIAppearance
  ...
  static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): DKCarouselView; // inherited from UIAppearance
  ...
  setItems(items: NSArray<any>): void;
}
